...
- intellectual_attractiveness (지적 매력): 판단 비중은 대략 이렇게:
  - 학력/대학 수준 (50%): 바이오, 캡션, 사진에서 드러나는 학력이나 대학 수준을 추정해서 평가. 명문대, 유학 경험, 전문 학위 등이 드러나면 높게.
  - 캡션의 지성, 글 솜씨, 관심사 깊이 (50%): 유머, 글쓰기 능력, 지적 관심사의 폭과 깊이.
- social_attractiveness (사회적 매력): 이 사람의 경제력과 사회적 지위를 추정해서 평가해. 판단 비중은 대략 이렇게:
  - 직업/커리어 (50%): 바이오, 캡션, 사진에서 드러나는 직업적 위치. 전문직, 사업가, 크리에이터 등 직업의 질.
  - 재력/라이프스타일 수준 (50%): 사진 속 여행지, 레스토랑, 패션 브랜드, 차, 주거 환경 등에서 추정되는 경제적 수준.
